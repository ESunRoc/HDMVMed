...
#'
#' `hdmvmed_test_data` contains a simulated data set that can be used to test/understand the high-dimensional multivariate mediation model of Sun et al. (2026).
#'
#' @name hdmvmed_test_data
#'
